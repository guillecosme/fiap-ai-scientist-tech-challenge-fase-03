...
ROTULOS: dict[str, str] = {
    ...
    "aprovação_ai_pct": "Taxa de aprovação, anos iniciais (%)",
    "aprovação_1ano_pct": "Taxa de aprovação no 1o ano (%)",
    "aprovação_2ano_pct": "Taxa de aprovação no 2o ano (%)",
    "reprovação_ai_pct": "Taxa de reprovação, anos iniciais (%)",
    ...
    "pct_vab_indústria": "Peso da indústria na economia (%)",
    "pct_vab_adm_publica": "Peso da administração pública na economia (%)",
    "pct_vab_serviços": "Peso dos serviços na economia (%)",
