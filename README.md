...
- **Fontes municipais de natureza nova.** Gasto por aluno em manutenção e desenvolvimento do ensino (SIOPE, FNDE) como variável de gestão financeira, e condições da primeira infância (baixo peso ao nascer, pré-natal e mortalidade infantil, do DATASUS) como antecedentes da alfabetização. As demais fontes públicas de contexto (CadÚnico, Censo 2022, questionário do Saeb) repetem o bloco socioeconômico, que a EDA mostrou fraco. O SIOPE tem defasagem de dois anos entre o exercício e a declaração homologada, o que precisa ser respeitado no alinhamento temporal; qualquer bloco novo entra pela ablação e pelo intervalo pareado contra o modelo atual, e só fica se a diferença não cruzar zero.
